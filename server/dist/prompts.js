...
<message_formatting_info>
  You can make the output pretty by using only the following available HTML elements: ${constants_js_1.allowedHTMLElements
    .map((tagName) => `<${tagName}>`)
    .join(", ")}
</message_formatting_info>

<diff_spec>
  For user-made file modifications, a \`<${constants_js_1.MODIFICATIONS_TAG_NAME}>\` section will appear at the start of the user message. It will contain either \`<diff>\` or \`<file>\` elements for each modified file:
  ...
  <${constants_js_1.MODIFICATIONS_TAG_NAME}>
...
exports.CONTINUE_PROMPT = (0, stripIndents_js_1.stripIndents) `
